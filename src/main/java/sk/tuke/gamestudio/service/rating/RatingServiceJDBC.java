...
public class RatingServiceJDBC implements RatingService {
  ...
  public static final String SELECT = "SELECT game, username, value, created_at FROM rating WHERE game = ?";
  public static final String SELECT2 = "SELECT value FROM rating WHERE game = ? AND username = ?";
  public static final String DELETE = "DELETE FROM rating";
  public static final String INSERT = "INSERT INTO rating (game, username, value, created_at) VALUES (?, ?, ?, ?)";
  ...
  public void setRating(Rating rating) throws RatingException {
    try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
      ...
      statement.setTimestamp(4, new Timestamp(rating.getCreatedAt().getTime()));
